...
export default class DetailsProjetParIdSesIdProjet extends Component {
    ...
    updateAvisCharge=(e)=>{
       // e.preventDefault();
        ...
        alert('verification avis avec success')
    }
    ...
    test = (e) => {
        ...
        else if(this.state.dossierValide == true){
            if(this.state.Avis ==''){
                          ...
                          <div className="panel-group" id="divValide">
...

                            {
                                ...
                                <div className="form-group" id={"divAvis"}>
                                    ...
                                    &nbsp;
                                    <input type="radio" value="refusee_1er_tour" id="avis3"  name="avis" onChange={this.handleAvis} />
