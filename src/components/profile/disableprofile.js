...
export default class disableprofile extends React.Component{
        ...
        <div id="content-container">
          <div className="pageheader hidden-xs">
            ...
            <div className="breadcrumb-wrapper">
              ...
              <ol className="breadcrumb">
                <li> <a href="/"> Home </a> </li>
                <li className="active"> Disable your Profile </li>
              </ol>
            </div>
          </div>
          {/*Page content*/}
          ...
          <div id="page-content">
            <div className="row">
              ...
              <p className="td"> Are you sur that you wanna disabled your profile ?</p>
        
         
        
        
        <div className="panel-footer text-right">
                                                <button className="btn btn-danger" onClick={this.handleClick}  type="submit">Yes</button>
                                                    <a href="/profile" className="btn btn-info" type="submit">No</a>
